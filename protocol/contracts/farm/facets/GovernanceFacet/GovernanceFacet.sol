...
contract GovernanceFacet is VotingBooth {
    ...
    **/
     ...
     * Multiple Unvotes
    **/
    // Takes in a list of bips and unvotes them
    function unvoteList(uint32[] calldata bip_list) external {
        require(balanceOfRoots(msg.sender) > 0, "Governance: Must have Stalk.");
    ...
    /**
     * Multiple Votes and Unvotes
    **/
    function voteUnvoteList(uint32[] calldata bip_list) external {
        require(balanceOfRoots(msg.sender) > 0, "Governance: Must have Stalk.");
